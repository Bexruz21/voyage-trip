            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mt-16">
                    ...
                    <button
                        ...
                        className="bg-gradient-to-r from-[#e17100] to-[#ff8c00] text-white px-14 py-4 rounded-full font-semibold text-lg cursor-pointer hover:shadow-2xl hover:shadow-[#e17100]/25 transition-all duration-200"
                    >
                        Получить карту
                    </button>
                </div>
