                    ...
                    <div className="flex justify-between items-center py-4">
                        ...
                        <nav className="hidden lg:flex items-center space-x-1">
                            {navItems.map((item, index) => {
                                ...
                                const linkClass = `relative px-6 py-3 rounded-xl font-semibold transition-all duration-300 group ${
                                    isActive
                            ...
                            {isClient ? (
                                ...
                                >
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:shadow-cyan-500/25 transition-all duration-300"
                                    >
                                        Подобрать тур
                                    </motion.button>
                                </motion.div>
                                ...
                                <div className="ml-4">
                                    <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-xl shadow-lg">
                                        Подобрать тур
                                    </button>
                                </div>
                            )}
                                ...
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                                    <div className="space-y-2">
                                        ...
                                        >
                                            <motion.button
                                                whileTap={{ scale: 0.95 }}
                                                className="w-full px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-xl shadow-lg text-center"
                                            >
                                                Подобрать тур
                                            </motion.button>
                                        </motion.div>
