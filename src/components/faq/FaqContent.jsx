...
const faqItems = [
    ...
    },
    {
        ...
        answer: "1. После 1 тура\n\n🎁 Бонус — 2 % кэшбэк в виде ваучера на следующий тур\n(Использовать можно в течение 12 мес. Не суммируется с другими акциями)\n\n2. После 3 туров\n\n🌟 Статус “Постоянный клиент” + персональное сопровождение\n • 5 % ваучер на следующий тур (вместо скидки)\n • доступ к закрытым предложениям\n\n3. После 5 туров\n\n🏆 Статус “Gold Client”\n • Индивидуальные предложения\n • Приоритетное бронирование\n • Возможность участия в розыгрышах и закрытых мероприятиях\n\n4. После 10 туров\n\n💼 Статус “Platinum Client”\n • VIP-обслуживание\n • Доступ к эксклюзивным мероприятиям и подаркам\n • 1 раз в год участие в розыгрыше крупного приза (часы / путёвка / сертификат и т.д.)",
        category: "booking"
    }
