...
export default function LicensesPage() {
    const pdfUrl = "/documents/license.pdf";
    const { t } = useLang()
    return (
                            ...
                            <div className="lg:col-span-1 space-y-4">
                                <div className="bg-blue-50 rounded-lg p-4">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        <div>
                                            <span className="text-gray-600">{t("license.details.number")}:</span>
                                            <p className="font-medium">№1095974</p>
                                        </div>
                                        <div>
                                            <span className="text-gray-600">{t("license.details.issueDate")}</span>
                                            <p className="font-medium">15.10.2025</p>
                                        </div>
                                        <div>
                                            <span className="text-gray-600">{t("license.details.status")}:</span>
                                            <span className="inline-flex items-center px-2 py-1 rounded-full bg-green-100 text-green-800 text-xs font-medium">
                                                {t("license.details.statusActive")}
                                            </span>
                                        </div>
                                    </div>
                                </div>
